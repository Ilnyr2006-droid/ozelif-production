export const CATALOG_SEO_LANDINGS = Object.freeze([
  ...
  Object.freeze({
    path: '/odejnayakozha/gladkaya',
    categorySlug: 'odejnayakozha',
    categoryName: 'Одежная кожа',
    parentPath: '/odejnayakozha',
    title: 'Гладкая натуральная кожа',
    label: 'Гладкая кожа',
    matcherTokens: Object.freeze(['гладк', 'gladk']),
  }),
  Object.freeze({
    path: '/odejnayakozha/fakturnaya',
    categorySlug: 'odejnayakozha',
    categoryName: 'Одежная кожа',
    parentPath: '/odejnayakozha',
    title: 'Фактурная натуральная кожа',
    label: 'Фактурная кожа',
    matcherTokens: Object.freeze(['фактур', 'fakturn']),
  }),
  Object.freeze({
