...
const COMMERCIAL:Record<string,CommercialProfile>={
  dublyonka:{metaTitle:'Дублёночный материал купить в Москве — натуральная овчина | OZELIF',metaDescription:'Каталог натурального дублёночного материала OZELIF: цены и характеристики, подбор по типу, цвету, отделке и размеру шкур. Розница и опт, шоурум в Москве, доставка по России.',kicker:'Натуральная овчина · Москва',h1:'Дублёночный материал для пошива',intro:'Каталог натурального дублёночного материала с актуальными ценами и характеристиками. Сравнивайте типы, оттенки, отделку и размеры шкур; OZELIF работает в розницу и оптом.',choiceTitle:'Как выбрать дублёночный материал',choiceText:'Сравнивайте тип материала, цвет, размер шкуры, покрытие и происхождение по карточкам. Для верхней одежды и дизайнерских изделий менеджер поможет сверить материал с задачей.',buyTitle:'Купить дублёночный материал в Москве',buyText:'Цена и единица продажи указаны в карточке каждого товара. Конкретную партию, оттенок и объём лучше подтвердить у менеджера перед заказом.'},
  zamsha:{metaTitle:'Натуральная замша купить в Москве — замшевая кожа | OZELIF',metaDescription:'Каталог натуральной замши OZELIF с ценами и характеристиками. Подбор по цвету, типу сырья и фактуре для одежды, обуви и кожгалантереи. Розница и опт, шоурум в Москве.',kicker:'Натуральная замша · Москва',h1:'Натуральная замша',intro:'Каталог натуральной замши с актуальными ценами и характеристиками. Подберите материал по цвету, типу сырья и фактуре для одежды, обуви и изделий из кожи.',choiceTitle:'Как выбрать натуральную замшу',choiceText:'Ориентируйтесь на назначение изделия, цвет, сырьё и характеристики конкретной позиции. Для точного выбора материал можно посмотреть и сравнить в московском шоуруме.',buyTitle:'Купить натуральную замшу в Москве',buyText:'В карточках опубликованы актуальные варианты, цены и характеристики. Для оптовой партии или точного попадания в оттенок свяжитесь с менеджером.'},
  obuvnayakozha:{metaTitle:'Обувная кожа купить в Москве — натуральная кожа для обуви | OZELIF',metaDescription:'Каталог натуральной обувной кожи OZELIF: цены и характеристики, подбор по цвету, сырью и фактуре. Розница и опт, шоурум в Москве, доставка по России.',kicker:'Натуральная кожа · Москва',h1:'Натуральная обувная кожа',intro:'Каталог натуральной кожи для пошива обуви и аксессуаров с актуальными ценами и характеристиками. Сравнивайте реальные параметры товаров и выбирайте материал под конкретную задачу.',choiceTitle:'Как выбрать обувную кожу',choiceText:'Сравните сырьё, цвет, фактуру, размер шкуры и другие параметры карточки. Менеджер поможет подобрать вариант под модель обуви и требования производства.',buyTitle:'Купить обувную кожу в Москве',buyText:'OZELIF продаёт материалы в розницу и оптом. Цена и единица продажи указаны в карточках; наличие нужной партии и объём подтверждаются менеджером.'},
  ...
  furnitura:{metaTitle:'Фурнитура для кожи купить в Москве — молнии, кнопки, комплектующие | OZELIF',metaDescription:'Каталог фурнитуры OZELIF для одежды и изделий из кожи: молнии, кнопки и комплектующие с ценами и характеристиками. Подбор по типу, бренду, длине и цвету.',kicker:'Комплектующие · Москва',h1:'Фурнитура для кожи и одежды',intro:'Каталог фурнитуры и комплектующих с актуальными ценами и характеристиками. Используйте фильтры по типу, бренду, длине и цветам, чтобы подобрать вариант под изделие.',choiceTitle:'Как выбрать фурнитуру',choiceText:'Сверяйте тип комплектующего, бренд, длину, цвет металла и тесьмы по данным карточек. Если нужна совместимость с конкретным изделием, уточните параметры у менеджера.',buyTitle:'Купить фурнитуру для кожи в Москве',buyText:'В каталоге опубликованы реальные позиции и цены. Наличие конкретного цвета, длины или партии подтверждается менеджером перед заказом.'}
}
