      ...
      <section className="seo section">
        <details open>
          ...
          <div>
            ...
            <p>
              Натуральную кожу можно купить в розницу. Для оптовых закупок
              действует отдельная страница{' '}
              <a href="/kozhaoptom">«Кожа оптом в Москве»</a>.
              В карточках товаров опубликованы актуальные цены и характеристики;
              наличие нужной партии и объём заказа подтверждает менеджер.
            </p>
            <p>
