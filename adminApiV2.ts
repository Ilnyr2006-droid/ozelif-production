...
export type CrmOrder = { id: string; public_number: string; status: string; total_amount: string; currency: string; delivery_city?: string | null; customer_comment?: string | null; source?: string; items_summary?: string; delivery_method: string | null; delivery_company: string | null; tracking_number: string | null; created_at: string; updated_at: string; customer_name: string | null; original_phone: string }
